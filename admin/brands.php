...
include_once '../classes/Marques.php';
...
if($_SERVER['REQUEST_METHOD']=='POST')
{
    ...
    {
        $marque->setMarque($fm->validation($_POST['nom']));
        $resultat = $dao->addMarque($marque);
        if ($resultat){
            $msg = "Marques Ajouté";
        }
        else{
                    ...
                    <div class="col-12 col-md-12 col-xxl-4 d-flex">
                        ...
                        <div class="card flex-fill w-100">
                            <div class="card-header">
                                <h2 class="card-title mb-0">Marques</h2>
                                                ...
                                                if ($row)
                                                {
                                                    foreach ($row as $document)
                                                    {
                                                        ...
                                                        <tr role="row" class="odd">
                                                            ...
                                                            <td>
                                                                <a href="?edit=<?=$document->id_marque ?>" type="button" class="btn btn-link">
                                                                    <i class="fas fa-edit"></i>
                                                                </a>
                                                                <a href="?del=<?=$document->id_marque ?>">
                            ...
                            <form method="post" action="" enctype="multipart/form-data">
                                ...
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h3 class="text-center">Ajouter une Marque</h3>
                                    ...
                                    <div class="modal-body m-3">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" id="nom" name="nom" class="form-control" placeholder="Marque" required>
